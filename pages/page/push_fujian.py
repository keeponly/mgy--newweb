...
class PushFile(BasePage):
    def push_file(self, locat):
        ...
        self.push()
        # 关闭上传弹窗
        fanhui_01 = self.wait_clickable_element((By.XPATH, '//a[@class="closetitle iconfont icon-shanchu"]'))
        fanhui_01.click()
        time.sleep(3)
        file_02 = self.wait_clickable_element((By.XPATH, '//a[@class="search-btn fl"]'))
        file_02.click()
        time.sleep(2)
        fanhui_01 = self.wait_clickable_element((By.XPATH ,'//a[@class="closetitle iconfont icon-shanchu"]'))
        fanhui_01.click()
        # 协同
        company_01 = self.wait_clickable_element((By.XPATH, '//*[@id="app"]/div[2]/div/div[1]/div[1]/div/div/div/div/div[2]/div[1]/div[1]/span[2]/span'))
        company_01.click()
        time.sleep(2)
